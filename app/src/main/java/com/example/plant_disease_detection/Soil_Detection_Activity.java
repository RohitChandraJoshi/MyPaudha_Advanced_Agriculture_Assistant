...
import com.example.plant_disease_detection.ml.SoilDetection;
...
public class Soil_Detection_Activity extends AppCompatActivity {
    ...
    private void classifyImage(Bitmap image) {
        try {
            ...
            SoilDetection.Outputs outputs = model.process(inputFeatureO);
...
//            String[] classes = {"Yellow Soil",
//                    "Peat Soil",
//                    "Laterite Soil",
//                    "Cinder Soil",
//                    "Black Soil"};

            result2.setText("suitable plants for : "+classes[maxPos]);
